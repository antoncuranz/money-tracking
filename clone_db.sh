...
export PGPASSWORD="op://Kubernetes/cloudnative-pg/POSTGRES_SUPER_PASS"
op run -- pg_dump --dbname=money-tracking --format=p --inserts --clean --if-exists --file=./money-tracking.sql --username=postgres --host=192.168.1.11 --port=5432
