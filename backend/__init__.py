...
def configure(binder):
    ...
    binder.bind(DateService, to=date_service, scope=singleton)
    binder.bind(ImportService, to=ImportService(quiltt_service, exchange_service, actual_service, date_service), scope=singleton)
