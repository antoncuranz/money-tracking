from models import Account, Transaction, Credit, Payment, CreditTransaction, User, BankAccount, PlaidConnection, \
    PlaidAccount
from tests.fixtures import ACCOUNT_1, ALICE_AUTH, ALICE_USER, BANK_ACCOUNT_1, PLAID_CONNECTION_1, PLAID_ACCOUNT_1
import pytest
